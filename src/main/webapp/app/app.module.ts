...
import { TicketingProjectCoreModule } from 'app/core';
import { TicketingProjectAppRoutingModule } from './app-routing.module';
...
@NgModule({
  imports: [
    ...
    TicketingProjectSharedModule.forRoot(),
    TicketingProjectCoreModule,
    TicketingProjectHomeModule,
